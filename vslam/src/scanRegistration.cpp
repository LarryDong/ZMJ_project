...
int main(int argc, char **argv){
    ...
    ros::NodeHandle nh;
    ROS_WARN("--> (ver) Registration node begin...");
    ...
    // pub 5 topics.
    pubLaserCloud = nh.advertise<sensor_msgs::PointCloud2>("/vlslidar_point_cloud_2", 100);
    pubCornerPointsSharp = nh.advertise<sensor_msgs::PointCloud2>("/vlaser_cloud_sharp", 100);
    pubCornerPointsLessSharp = nh.advertise<sensor_msgs::PointCloud2>("/vlaser_cloud_less_sharp", 100);
    pubSurfPointsFlat = nh.advertise<sensor_msgs::PointCloud2>("/vlaser_cloud_flat", 100);
    pubSurfPointsLessFlat = nh.advertise<sensor_msgs::PointCloud2>("/vlaser_cloud_less_flat", 100);
